...
# Only creates aliases if they don't already exist (e.g., from external SUNDIALS)
function(create_sundials_aliases)
    ...
    if(BUILD_SHARED_LIBS)
        ...
        if(MagneX_MPI AND NOT TARGET SUNDIALS::nvecmpimanyvector)
    ...
    if(BUILD_SHARED_LIBS)
        if(MagneX_COMPUTE STREQUAL CUDA AND TARGET sundials_nveccuda_shared AND NOT TARGET SUNDIALS::nveccuda)
        ...
        elseif(MagneX_COMPUTE STREQUAL HIP AND TARGET sundials_nvechip_shared AND NOT TARGET SUNDIALS::nvechip)
        ...
        elseif(MagneX_COMPUTE STREQUAL OMP AND TARGET sundials_nvecopenmp_shared AND NOT TARGET SUNDIALS::nvecopenmp)
            add_library(SUNDIALS::nvecopenmp ALIAS sundials_nvecopenmp_shared)
        endif()
    else()
        if(MagneX_COMPUTE STREQUAL CUDA AND TARGET sundials_nveccuda_static AND NOT TARGET SUNDIALS::nveccuda)
        ...
        elseif(MagneX_COMPUTE STREQUAL HIP AND TARGET sundials_nvechip_static AND NOT TARGET SUNDIALS::nvechip)
        ...
        elseif(MagneX_COMPUTE STREQUAL OMP AND TARGET sundials_nvecopenmp_static AND NOT TARGET SUNDIALS::nvecopenmp)

            ...
            [=] AMREX_GPU_DEVICE(int i, int j, int k) {
                ...
                if (Ms_arr(i,j,k) > 0.){
                    ...
                    if (DMI_coupling == 1){
                        ...
                        amrex::Real dMzdy_BC_lo_y =  0.;//1.0/xi_DMI*My(i,j,k); // lower y BC: dMz/dy = -1/xi*My
                        amrex::Real dMzdy_BC_hi_y =  0.;//1.0/xi_DMI*My(i,j,k); // higher y BC: dMz/dy = 1/xi*My
                        ...
                        amrex::Real dMydy_BC_lo_y = 0.;//-1.0/xi_DMI*Mz(i,j,k); // lower y BC: dMy/dy = 1/xi*Mz
                        amrex::Real dMydy_BC_hi_y = 0.;//-1.0/xi_DMI*Mz(i,j,k); // higher y BC: dMy/dy = -1/xi*Mz
